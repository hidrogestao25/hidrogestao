...
path('contratos_fornecedores/<int:pk>/ocultar-home-vencido/', views.ocultar_contrato_vencido_home, name='ocultar_contrato_vencido_home'),
...
path('aditivos_fornecedor/eventos/<int:pk>/editar/', views.editar_evento_aditivo, name='editar_evento_aditivo'),
    ...
    path("os/<int:os_id>/cadastrar-nf/", views.cadastrar_nf_os, name="cadastrar_nf_os"),
    ...
    path("os/<int:os_id>/bm/novo/", views.cadastrar_bm_os, name="cadastrar_bm_os"),
    ...
    path("contratos-guarda-chuva/<int:contrato_id>/cadastrar-os/", views.cadastrar_os_contrato_guarda_chuva, name="cadastrar_os_contrato_guarda_chuva"),
    ...
    path('ordem-servico/<int:pk>/gerar-docm/', views.gerar_os_docm, name='gerar_os_docm'),
